...
void board_Init(void){
	...
	for(i = 17; i < 210; i+=30){
		for(j = 0; j < 210; j+=5){ 
			LCD_DrawLine(i, j, 25+i, j, Black);
			LCD_DrawLine(j+17, i-17, j+17, 25+i-17, Black);
			j+=25;
			LCD_DrawLine(i, j, 25+i, j, Black);
			LCD_DrawLine(j+17, i-17, j+17, 25+i-17, Black);
	...
	i=18;
	j=230;
	LCD_DrawLine(i, j, 70+i, j, Black);
	LCD_DrawLine(135+i, j, 205+i, j, Black);
	LCD_DrawLine(i, j+70, 70+i, j+70, Black);
	LCD_DrawLine(135+i, j+70, 205+i, j+70, Black);
	LCD_DrawLine(i, j, i, j+70, Black);
	LCD_DrawLine(i+70, j, i+70, j+70, Black);
	LCD_DrawLine(i+135, j, i+135, j+70, Black);
	LCD_DrawLine(i+205, j, i+205, j+70, Black);
	GUI_Text(21, 234, (uint8_t *) "Player 1", Red, White);
	GUI_Text(138+i, 234, (uint8_t *) "Player 2", Blue, White);
	
}
void FillCell(int x, int y, uint16_t color){
	int x1=(x/2);
	int i, j;
	int y1=(y/2);
	y1=y1*15;
	...
	for(i = y1+1; i < 25+y1; i++){
		LCD_SetCursor(x1, y1+i);
		
		LCD_WriteIndex(0x0022);
		
		for(j = x1+1; j < 25+x1; j++){
			LCD_WriteData(color);
		}
	}
}
void Fill_muro_Or(int x, int y,uint16_t color){
	int x1=((x+1)/2);
	int i, j,t;
	int y1=((y+1)/2);
	y1=y1*15;
...
void Fill_muro_Or_Singl(int x, int y,uint16_t color){
	int x1=((x+1)/2);
	int i, j,t;
	int y1=((y+1)/2);
	y1=y1*15;
...
void Fill_muro_Ver(int x, int y,uint16_t color){
	int x1=((x+1)/2);
	int i, j;
	int y1=((y+1)/2);
	y1=y1*15;
...
void Fill_muro_Ver_Singl(int x, int y,uint16_t color){
	int x1=((x+1)/2);
	int i, j,t;
	int y1=((y+1)/2);
	y1=y1*15;
